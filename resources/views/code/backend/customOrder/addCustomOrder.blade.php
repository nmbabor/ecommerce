...
<h3 class="box_title">Add New Custom Order <a href="{{URL::to('/viewCustomOrders')}}" class="pull-right btn btn-success">View Custom Orders</a></h3>
    <div class="box-body col-md-10">
        {!! Form::open(array('route' => 'addCustomOrder.store','class'=>'form-horizontal','method'=>'POST','files'=>'true')) !!}
        ...
        <div class="form-group {{ $errors->has('price') ? 'has-error' : '' }}">
            ...
            <div class="col-md-8">
                {{Form::number('price','',array('class'=>'form-control','placeholder'=>'Enter Price','required'))}}
                @if ($errors->has('price'))
                    <span class="help-block">
