...
<h4 class="box_title">Attribute Option @if(isset($allData['attributes']))
<? echo 'of "'.$allData['attributes']['name'].'", Category:<b>'.$allData['attributes']['category_name'].'</b>'; ?>
@endif
 <a href="{{URL::to('attribute/'.$allData['attributes']['category_id'])}}" class="btn btn-default pull-right"> <i class="ion ion-navicon-round"></i> View attribute</a></h4>
    {!! Form::open(array('route' => 'attribute-option.store','class'=>'form-horizontal','id'=>'form_submit')) !!}
        ...
        <div class="form-group">
            ...
            <div class="col-md-8">
                {{Form::number('attribute_price','',array('class'=>'form-control','placeholder'=>'Price','required'))}}
            </div>
        </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
            {{Form::label('attribute_price', 'Price', array('class' => 'col-md-3 control-label'))}}
            <div class="col-md-9">
                {{Form::number('attribute_price',$data->attribute_price,array('class'=>'form-control','placeholder'=>'Price','required'))}}
                {{Form::hidden('id',$data->id)}}
                {{Form::hidden('fk_attribute_id',$data->fk_attribute_id)}}
            </div>
        </div>
