...
<h4 class="box_title">Attribute  @if(isset($allData['sub_category']))
{{ "of '".$allData['sub_category']['category_name'].' : '.$allData['sub_category']['sub_category_name']."'"}}
<? $cat_id=$allData['sub_category']['category_id']; ?>
@endif
 <a href='{{URL::to("subCategory/$cat_id")}}' class="btn btn-default pull-right"> <i class="ion ion-navicon-round"></i> View Sub Category</a></h4>
