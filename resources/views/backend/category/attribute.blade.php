...
<h4 class="box_title">Attribute  @if(isset($allData['category']))
{{ 'of "'.$allData['category']['category_name'].'"'}}
@endif
 <a href="{{route('categories.index')}}" class="btn btn-default pull-right"> <i class="ion ion-navicon-round"></i> View Category</a></h4>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
            ...
            <div class="col-md-5">
                {{Form::select('attribute_type', array('1' => 'Select Option', '2' => 'Check Box'),$data->attribute_type, ['class' => 'form-control','required'])}}
            </div>
