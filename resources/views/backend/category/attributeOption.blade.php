...
<h4 class="box_title">
 ...
 @if(isset($allData['attributes']))
     <p> <b>Attribute: </b>{{$allData['attributes']['name']}}<br> 
     <b>Category: </b> {{$allData['attributes']['category_name']}}<br> 
     @if(isset($allData['attributes']['sub_category_name']) )
     <b>Sub Category: </b> {{$allData['attributes']['sub_category_name']}} <br> 
     @endif
     @if(isset($allData['attributes']['sub_name']) )
     <b>Sub Sub Category: </b> {{$allData['attributes']['sub_name']}} 
     @endif
     </p>
@endif
 </div>
 <div class="col-md-8">
     {!! Form::open(array('route' => 'attribute-option.store','class'=>'form-horizontal','id'=>'form_submit')) !!}
        ...
        <div class="form-group">
            {{Form::label('attribute_price', 'Price', array('class' => 'col-md-3 control-label'))}}
            <div class="col-md-8">
                {{Form::number('attribute_price','',array('class'=>'form-control','placeholder'=>'Price','step'=>'any'))}}
            </div>
        </div>
        <div class="form-group">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <div class="form-group">
            {{Form::label('attribute_price', 'Price', array('class' => 'col-md-3 control-label'))}}
            <div class="col-md-9">
                {{Form::number('attribute_price',$data->attribute_price,array('class'=>'form-control','placeholder'=>'Price','step'=>'any'))}}
                {{Form::hidden('id',$data->id)}}
                {{Form::hidden('fk_attribute_id',$data->fk_attribute_id)}}
            </div>
        </div>
