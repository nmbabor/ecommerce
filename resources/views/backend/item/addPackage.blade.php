    ...
    <div class="box-body col-md-12">
        ...
        <div class="col-md-12">
            ...
            {{Form::label('price', 'Package Price', array('class' => 'col-md-2 control-label'))}}
                <div class="col-md-3">
                    {{Form::number('price','',array('class'=>'form-control','placeholder'=>'Enter Package Price','required','step'=>'any'))}}
                    @if ($errors->has('price'))
                        <span class="help-block">
                            ...
                            <div class="modal-content">
                              ...
                              <div class="modal-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        {{Form::text('price',$data->price,array('class'=>'form-control','placeholder'=>'Package Price','required','step'=>'any'))}}
                                        {{Form::hidden('id',$data->id)}}
                                    </div>
                                </div>
                                <div class="form-group">
