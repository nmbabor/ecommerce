...
<h3 class="box_title">Add New Item</h3>
    <div class="box-body col-md-10">
        ...
        <div class="form-group {{ $errors->has('sale_price') ? 'has-error' : '' }}">
            ...
            <div class="col-md-8">
                {{Form::number('sale_price','',array('class'=>'form-control','placeholder'=>'Enter Sale Price','required','step'=>'any'))}}
        ...
        <div class="form-group {{ $errors->has('regular_price') ? 'has-error' : '' }}">
            ...
            <div class="col-md-8">
                {{Form::number('regular_price','',array('class'=>'form-control','placeholder'=>'Enter Regular Price','required','step'=>'any'))}}
