...
class SalesSupportController extends Controller
{
    ...
    public function index()
    {
        ...
        $max_serial=SalesSupport::max('serial_num');
        $allData= SalesSupport::orderBy('serial_num','asc')->paginate(10);
        return view('backend.support.index', compact('allData','max_serial'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        $input=$request->all();
        $data=SalesSupport::findOrFail($id);
        try{
            $data->update($input);
            $bug=0;
        }catch(\Exception $e){
